...
IP network rules doesn't allow Azure In-Region Public IP addresses. A storage account can only be accessed from Azure Public IP addresses if those are deployed in a different Region.
